namespace Intelica.Authentication.API.Domain.AuthenticationAggregate.Application.DTO
{
    ...
    public record AuthenticationData(string BusinessUserName, string BusinessUserEmail, Guid BusinessUserID, string BusinessUserProfile, string BusinessUserPhoto);
